...
import com.example.duong.gdgfinder.databinding.ListDgdFragmentBinding
...
class GdgListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding = DataBindingUtil.
            inflate<ListDgdFragmentBinding>(inflater,
            R.layout.list_dgd_fragment,
                container,false)
        ...
        binding.listDgdViewModel = viewModel
